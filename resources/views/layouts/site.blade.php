...
<body>
        <header class="header">
                <a href="{{url('/')}}" class="logo"><?xml version="1.0" encoding="UTF-8" standalone="no"?>
                        <svg
                                ...
                                width="220px"
                                height="35px"
                                viewBox="0 0 201.86614 45.973999"
                                version="1.1"
                                id="svg8"
                                inkscape:version="0.92.2 (5c3e80d, 2017-08-06)"
                                sodipodi:docname="hyperaffle.svg">
                                <defs
                                        id="defs2" />
                                <sodipodi:namedview
                                        id="base"
